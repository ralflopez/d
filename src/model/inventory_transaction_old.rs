...
// use super::{
//     common::RowWithId,
//     enums::{InventoryLogAction, InventoryTransactionAction},
//     inventory_log::{add_logs, InventoryLogForCreateOld},
//     pageable::Pageable,
...
//         .items
//         .into_iter()
//         .map(InventoryLogForCreateOld::from)
//         .collect();
...
//     let items: Vec<InventoryLogForCreateOld> = sell_for_create
//         .items
//         .into_iter()
//         .map(InventoryLogForCreateOld::from)
//         .collect();
